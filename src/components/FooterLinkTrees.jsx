...
function FooterLinkTrees() {
    return <div className={`fluid ${style.footerLinkTreesContainer}`}>
        <div className={style.row}>
            <div className={`d-flex ${style.trees} ${style.footerColumn}`}>
                <div className={style.treeRow}>
            ...
            <div className={style.footerColumn}>
                <img className={style.logoImg} src="/img/dc-logo-bg.png" alt="dc logo overlay image"></img>
            </div>
        </div>
    </div>;
}
